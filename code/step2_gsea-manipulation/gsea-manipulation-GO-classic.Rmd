...
```{r}
genesets <- read_tsv(file = "local_classic_results/clusterprofilerout_GO/GENESET_local_classic_allgenes.tsv")
```
...
```{r}
genesets <- read_tsv(file = "local_classic_results/clusterprofilerout_GO/GENESET_local_classic_NDAGs.tsv")
```
...
```{r}
genesets <- read_tsv(file = "local_classic_results/clusterprofilerout_GO/GENESET_local_classic_DAGs.tsv")
```
